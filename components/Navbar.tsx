...
const socialLinks = [
  {
    ...
    icon: (
      <BsTwitterX className='h-6 w-6 text-foreground hover:text-off-white transition-colors' />
    ),
  },
  {
    ...
    icon: (
      <svg
        ...
        fill='currentColor'
        viewBox='0 0 24 24'
        className='h-6 w-6 text-foreground hover:text-off-white transition-colors'
      >
